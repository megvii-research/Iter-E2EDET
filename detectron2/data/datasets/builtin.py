...
imgDir = {'train': 'data/citypersons/train', 
          'val': 'data/citypersons/val'}
json_dir = 'data/citypersons/reasonable_annotations'

_PREDEFINED_SPLITS_CITYPERSONS = dict()
_PREDEFINED_SPLITS_CITYPERSONS["citypersons"] = {
    "cityperson_train": (imgDir['train'], osp.join(json_dir, 'train.json')),
    "cityperson_val": (imgDir['val'], osp.join(json_dir, 'val.json')),
}
